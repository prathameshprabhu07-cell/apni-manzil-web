...
const WarehouseStorage = () => {
  ...
  const handleWarehouseBooking = async (serviceTitle) => {
    ...
    if (serviceTitle === "Cold Storage") { navigate('/cold-storage'); return; }
  ...
  const warehouseServices = [
    { id: 1, title: "Short Term Storage", desc: "Flexible weekly or monthly storage for temporary needs.", icon: <Clock size={32} className="text-blue-600" />, color: "bg-blue-50" },
    { id: 2, title: "Long Term Storage", desc: "Secure long-term solutions for your excess inventory.", icon: <Calendar size={32} className="text-orange-600" />, color: "bg-orange-50" },
    { id: 3, title: "Fulfillment Warehouse", desc: "Complete pick, pack, and ship services for e-commerce.", icon: <Box size={32} className="text-green-600" />, color: "bg-green-50" },
    { id: 4, title: "Cold Storage", desc: "Temperature controlled storage for perishable goods.", icon: <Snowflake size={32} className="text-cyan-600" />, color: "bg-cyan-50" },
    { id: 5, title: "Inventory Management", desc: "Real-time tracking and management of your stock.", icon: <ClipboardList size={32} className="text-indigo-600" />, color: "bg-indigo-50" },
