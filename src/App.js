...
import VendorLandingPage from './pages/VendorLandingPage'; // किंवा तुमच्या फाईलच्या पाथनुसार बदला
import PackersMoversRegister from './pages/PackersMoversRegister'; // तुमचा नवीन फॉर्म (योग्य पाथ तपासून घ्या)
