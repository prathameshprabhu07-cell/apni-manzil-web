...
const CourierService = () => {
  ...
  // १. नवीन ८ सर्विसेस (image_321384.png प्रमाणे)
  const services = [
  ...
  // तुझे मूळ बुकिंग लॉजिक (अजिबात बदललेले नाही)
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f8f9fa' }}>
      ...
      {/* २. प्रोफेशनल नॅव्हबार (image_321384.png प्रमाणे) */}
      <nav style={navStyle}>
      ...
      {!selectedService ? (
        <>
          {/* ३. निळा हिरो बॅनर (image_321384.png प्रमाणे) */}
          ...
          {/* ४. ८ सर्विसेस ग्रीड (image_321384.png प्रमाणे) */}
        ...
        /* ६. तुझे मूळ बुकिंग फॉर्म सेक्शन */
      ...
      {/* ७. प्रोफेशनल ब्लू फुटर (image_327483.png प्रमाणे) */}
...
// --- Styles (image_321384.png आणि image_327483.png प्रमाणे) ---
...
const cardBoxStyle = { backgroundColor: '#fff', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', display: 'flex', alignItems: 'center', gap: '15px', border: '1px solid #eee' };
